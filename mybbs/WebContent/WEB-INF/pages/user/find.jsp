			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2 text">
						<h1>
							<strong>BBS</strong> find
						</h1>
						<div class="description">
							<p>Please use your E-mail for find!</p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-6 col-sm-offset-3 form-box">
						<div class="form-top">
							<div class="form-top-left">
								<h3>Find your E-mail</h3>
								<p>Use E-mail to find:</p>
							</div>
							...
							<form action="<%=basePath%>user/findPassword" method="post"
								...
								<div class="form-group">
									<label class="sr-only" for="form-password">Password</label> <input
										type="password" name="password" placeholder="NewPassword..."
